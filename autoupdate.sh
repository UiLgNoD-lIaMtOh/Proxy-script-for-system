...
# 更新url节点
update_url(){
    curl -SL --connect-timeout 30 -m 60 --speed-time 30 --speed-limit 1 --retry 2 -H "Connection: keep-alive" -k "https://raw.githubusercontent.com/UiLgNoD-lIaMtOh/docker-amd64-custom-ubuntu-topfreeproxies/master/topfreeproxies/singbox-config-format.json" -o "config0.json" -O
}

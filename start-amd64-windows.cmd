...
:ip0
curl -SL --connect-timeout 30 -m 60 --speed-time 30 --speed-limit 1 --retry 2 -H "Connection: keep-alive" -k "https://fastly.jsdelivr.net/gh/UiLgNoD-lIaMtOh/docker-amd64-custom-ubuntu-topfreeproxies@master/topfreeproxies/singbox-config-format.json" -o ".config\config.json"
